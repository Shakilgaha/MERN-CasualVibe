...
export const Login = () => {
    ...
    const { setTokenInLS, fetchUser, } = useAuth()
    ...
    return (
        <div className="min-h-screen  bg-violet-50 dark:bg-zinc-800 lg:px-4 py-12 lg:py-0 ">
            <motion.div
                initial={{
                    opacity: 0,
                    y: 50
                ...
                viewport={{
                    once: true
                }} className="w-full container rounded-lg flex flex-col justify-center items-center lg:grid lg:grid-cols-2 gap-10 ">
                {/* Left Section (Form) */}
                <div className="w-full flex flex-col justify-center bg-aber-400 items-center">
                    <h2 className="text-2xl font-bold text-indigo-600">Welcome Back to CasualVibe</h2>
                    <p className="text-gray-600 dark:text-zinc-300 mt-2">
                        Welcome back! Let’s get you back to exploring the latest styles.
                    </p>

                    {/* Form */}
                    <form
                        onSubmit={handleFormSubmit}
                        id="" className="mt-6 space-y-4 w-[24rem] md:w-[33rem] ">
                        ...
                        <span>  Don't Have An Account ? <NavLink to="/register">  SignUp  </NavLink> </span>
                    </form>
                </div>
